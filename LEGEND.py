...
MONGO_URI = 'mongodb+srv://DEVIL:TeamKLxHOPm@devils.dkyws.mongodb.net/?retryWrites=true&w=majority&appName=DEVILS'
...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7756760436:AAEpTAHmPl0k04ekOkTTdO-oKl0iqdjrcdE'
ADMIN_USER_ID = 5755964345
ADMIN_USER_ID = 0
...
async def attack(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=chat_id, text=( 
        ...
        f"*Give Feedback To Owner : @CRACKER_PRO_M*"
    ), parse_mode='Markdown')
